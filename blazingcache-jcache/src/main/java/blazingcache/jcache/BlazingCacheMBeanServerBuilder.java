...
/**
 * This class is taken from the JSR TCK in order to let the TCK run An
 * MBeanServer builder which creates a local MBeanServer.
 *
 * @author Greg Luck
 */
public class BlazingCacheMBeanServerBuilder extends MBeanServerBuilder {

    /**
     * Empty public constructor as required
     */
    public BlazingCacheMBeanServerBuilder() {
        super();
    }
