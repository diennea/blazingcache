...
public class RawString implements Comparable<RawString> {
    ...
    public boolean startsWith(RawString r) {
        return startsWith(this.data, this.data.length, r.data);
    }

    private static boolean startsWith(byte[] left, int len, byte[] right) {
