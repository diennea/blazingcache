    ...
    public void basicTest() throws Exception {
        ...
        try (CacheServer cacheServer = new CacheServer("ciao", serverHostData)) {
            ...
            try (CacheClient client1 = new CacheClient("theClient1", "ciao", new NettyCacheServerLocator(serverHostData));
                ...
                client1.put("pippo", data, System.currentTimeMillis() + 60000);
                client2.put("pippo", data, System.currentTimeMillis() + 60000);
                ...
                client1.put("pippo", data2, System.currentTimeMillis() + 60000);
